...
#INSTEAD OF 'SnippetList' AND 'SnippetDetail' AND 'SnippetHighlight' VIEWS, WE CAN
#   USE A VIEWSET!
class SnippetViewSet(viewsets.ModelViewSet):
    ...
    #this action responds to GET requests by default.
...
#INSTEAD OF 'UserList' AND 'UserDetail' VIEWS, WE CAN
#   USE A VIEWSET!
